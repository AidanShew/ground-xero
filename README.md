...
Firefight was hidden from the main menu to simplify the main menu and prioritize the Campaign, which is actively being developed.
...
2. Install GameMaker (LTS 2026 is recommended) from gamemaker.io
3. In the downloaded repository, open "Far From Eden Ground Xero.yyp"
4. Press F5 (Or click the play button at the top) to launch the game.
###### **Note** 
- This project was mostly tested on Windows 11, this may not behave as intended on other operating systems.
